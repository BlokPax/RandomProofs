...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "Sxx9Sb897WSe1UgRjSQapH9oIcQ04C1ymovnb7B8V0eXmeYcCZIihgoUTbGLfMza",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      f41427a5f3d31b59bf23fea6f216a96850d84bee5a7180217d7843170525016b
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xfbe33b71046067ba8d3e5af28d83e3e260d152f9af164ac14f243b668c26e6b7` ([polygonscan][random_txn])
  - The number we retrieved was: `101261486046221065204689447155623306839724476402149841823137879959974230618920`
...
[random_txn]: https://polygonscan.com/tx/0xfbe33b71046067ba8d3e5af28d83e3e260d152f9af164ac14f243b668c26e6b7

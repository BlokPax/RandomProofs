...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "GIZHH5WFSl03yVVsnY7TOf7xe14R5Sdd6SzYrrStICxKYD1PHtAlSkbyRSL9nedb",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      e99b1b6793340826048b91f0f4f98d350fd435eb6b0fe1a0c78d5edcec6433be
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xd4976aeddc1de173720a281393cbd398b6b4930e025aec1721a8d4a2aa62099f` ([polygonscan][random_txn])
  - The number we retrieved was: `24088098417877860809763734828953931994494299416410897637113081474072210050539`
...
[random_txn]: https://polygonscan.com/tx/0xd4976aeddc1de173720a281393cbd398b6b4930e025aec1721a8d4a2aa62099f

...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "NFHPFX6rNjYtk6ZVlwuBJsJSHSSBo3cxVzrmt2fWpbEClNMiDYKHOdQdwppCjwXG",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      572b7ff743ae80fdf65740ad207a05d7150e7c21028bc93716b408b426b3ada6
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x40fe96e4ff92a3ce8b3dbdef1179807dc357a093e23dee4f533c9be993e4fc5f` ([polygonscan][random_txn])
  - The number we retrieved was: `19397202591642132507006558249242097815601779134146961121211848595922618948083`
...
[random_txn]: https://polygonscan.com/tx/0x40fe96e4ff92a3ce8b3dbdef1179807dc357a093e23dee4f533c9be993e4fc5f

...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "Q9SiL7cvc4P2YgrZ51FTAFwLlxh1jpQGMDmlcJ6Z1QIaZ20M67gNCHcZzh3ZxIeC",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      eeeeb00d148cb0ff7482a85aae1db27fec909efb34e26339dedd717ce0c4db16
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xbeb4401cb1d662ea4f733fe841a6c4c4e56cba79b58a6e580e02651140b8e1cb` ([polygonscan][random_txn])
  - The number we retrieved was: `114700488897627880737890609465445507278132007354084258875858207368771758285036`
...
[random_txn]: https://polygonscan.com/tx/0xbeb4401cb1d662ea4f733fe841a6c4c4e56cba79b58a6e580e02651140b8e1cb

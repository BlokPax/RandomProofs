...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "qUOWGTXa1wTL7G3GDjIqVbkW9JT2zOsNhH4XvpVtLKGtxldibDGLo3ynjPlx2xOQ",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      491a845b7f8644d3684f1802ff3f938c6a353b7a8ed0fc1a72932587e1bcfb82
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x237af07ce357942f57042a4a17f6a38284f46b06e80868e72967179aaeb6d748` ([polygonscan][random_txn])
  - The number we retrieved was: `81386118419744734593150065216041479018506637914136944158786006394471617899760`
...
[random_txn]: https://polygonscan.com/tx/0x237af07ce357942f57042a4a17f6a38284f46b06e80868e72967179aaeb6d748

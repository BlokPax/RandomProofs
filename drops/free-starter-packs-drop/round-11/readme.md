...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "isSymqQW9MxJTvkbQjWwwdcabDBJEcPmbWaymv9NdssuyF0SdMcbkws1pLMtHblw",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      35682b67079981ebaea6a74120e2585dcdcc450e1c405445a6daa14b820fe900
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xe81e1bab8132b82617241b96bccfa678e99241fad1af352fe4ea55c6ecde4870` ([polygonscan][random_txn])
  - The number we retrieved was: `112750950497638455173244226895282105286806218138621886454952517080967621609856`
...
[random_txn]: https://polygonscan.com/tx/0xe81e1bab8132b82617241b96bccfa678e99241fad1af352fe4ea55c6ecde4870

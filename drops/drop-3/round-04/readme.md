...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "ea0Ro4EcSD5ag6H9RCWWdjYuk692EZf01gYAxXakmLAq12HcPh4SYNd8bLhLStj2",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      55429caa93442532db6f7e1bf38d90953c58c240c928e68ddeb37013fd523272
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xdc3f7ff86eedaeba2965dd80bc87619e289ef759fe5d2a476e158d5dc219a798` ([polygonscan][random_txn])
  - The number we retrieved was: `62618086358659644098477921669069046780932684444182055129733603961657072076028`
...
[random_txn]: https://polygonscan.com/tx/0xdc3f7ff86eedaeba2965dd80bc87619e289ef759fe5d2a476e158d5dc219a798

...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "RupXOTQSUw26GZRqz6yxR5R3UVTar2hHEZP0M48PaxPLj4gWPis07exFwEVL6nQP",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      66ae81a8c67eb73f9e90882cf2cfff889df72ef1e30c6a1ecdd81e423a142cf8
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xa423149af9bd5f415011a6f4eb20cc39a265288a2188a16f073fff133bc8f7c5` ([polygonscan][random_txn])
  - The number we retrieved was: `100064804505273199514059889597850180257177284641984245206424910586183680519286`
...
[random_txn]: https://polygonscan.com/tx/0xa423149af9bd5f415011a6f4eb20cc39a265288a2188a16f073fff133bc8f7c5

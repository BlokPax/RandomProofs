...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "c0HwDt7xgCjoBTTDBTLNgYijPHB9G7v8ZhgPnUtRDKzYW0vBGWesT3UK3zYhOSH3",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      c162879cc138fae25bdfb818765209ce0b0e108871521a4c43dcc963e9a06ffb
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x27329c3cb5ea868c76db0dc06ee4149408f3b46ec87a9460cb84c43819ca452a` ([polygonscan][random_txn])
  - The number we retrieved was: `75874820064256926068707103501473067159903755828398899758466001708099671834958`
...
[random_txn]: https://polygonscan.com/tx/0x27329c3cb5ea868c76db0dc06ee4149408f3b46ec87a9460cb84c43819ca452a

...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "p6IsCzWfFkCCxbPdTkn4f6AA2OOKSlbmQTfCXIownAuIF2qNVpsjVwNMzW5Tyl4F",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      10a09fd1e7e404546d90b622192016183d509dbd47b4d5a82dded9b146e139a9
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xbbe1c4e6441404bc78d73b91a42e832c572a8d42013def77255da96170ae9dc9` ([polygonscan][random_txn])
  - The number we retrieved was: `80952461372020202067414918779044981860711927302330259576650321864715507128304`
...
[random_txn]: https://polygonscan.com/tx/0xbbe1c4e6441404bc78d73b91a42e832c572a8d42013def77255da96170ae9dc9

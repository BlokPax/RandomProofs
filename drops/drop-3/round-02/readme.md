...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "FDQzhwy9HqVnLBKFY7D3sXDzrlkggioiYfp6RrrrM8bc1Va83NZPp8tk50DRVmJr",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      35c325646c4ea706964d5a727a66700efdc58170c5ee134230bdfc6d7bbff5ec
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x7cbe3424cfd63f7c43c41ed8b0a934f83a800847cd718d4ac156a3de66343840` ([polygonscan][random_txn])
  - The number we retrieved was: `54427931157253397841005650534417450294037041052226478607540160198663926173515`
...
[random_txn]: https://polygonscan.com/tx/0x7cbe3424cfd63f7c43c41ed8b0a934f83a800847cd718d4ac156a3de66343840

...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "eMxr8zqcnyo50M6ntPg2rAZ17IZAgjwOOJQkEC7XcG0HdLSKIQ0ArQQcbEqjvRvZ",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      ec934e81a6b95b3d2931cdd5e371c1667c68c96e88650b9e37e8c5577ed57274
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x1c55160c55370fd32de6712da48ead3ef520bc226e6b2c259c87ca5274cd87f8` ([polygonscan][random_txn])
  - The number we retrieved was: `26554197053152280986976235213172327502431311303503974686794345515024597663346`
...
[random_txn]: https://polygonscan.com/tx/0x1c55160c55370fd32de6712da48ead3ef520bc226e6b2c259c87ca5274cd87f8

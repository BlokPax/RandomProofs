...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "MqyQLgW9Og6vluJl2yTF9hfjCg1sEyo4MpSMd4xbQ9jFJxpU9XKOL93mUoBwquCQ",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      7afbce544f4cd7492e1c190fb16d943db88922eb7de59509a42f500736b93373
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x669ff4e39673fa853ee6d9a0ccc433aabc86572c1c2bc5cb8be364813d87c9c3` ([polygonscan][random_txn])
  - The number we retrieved was: `16581673299625370777478054950527271529789853537173216189932983834088984200372`
...
[random_txn]: https://polygonscan.com/tx/0x669ff4e39673fa853ee6d9a0ccc433aabc86572c1c2bc5cb8be364813d87c9c3

...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "EaQr9q8qoxuvxdLbghRuC6p6B6nTvFudjhsvw5Utb9QVKsDtEjupLz6EZXtAf2K2",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      28889041408646c46b11fb8511e52b3ac7f8a9e12689a897e767c677f055056f
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x03a4ff312e6ab04cf09fa9d97a1e252a4ba0179cea573e8f676d7268aa0cb922` ([polygonscan][random_txn])
  - The number we retrieved was: `14542954959309516047838142204588412768082578078192360605801836739228414660602`
...
[random_txn]: https://polygonscan.com/tx/0x03a4ff312e6ab04cf09fa9d97a1e252a4ba0179cea573e8f676d7268aa0cb922

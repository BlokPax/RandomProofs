...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "xiHwrHI7pNvQWK0oiEZ1YqdJRJIzF4H5iaQgtSPynAXiJq8DnpSS9azzfSDqEBYr",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      eb476a05cfd414470ca598267479f09d4f879691a07c2ea145e7223f7097c483
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x2e7f960e74bd8599dc8e7e16f8635c7ca06dc410d5a073ba0aeabe89c4570be8` ([polygonscan][random_txn])
  - The number we retrieved was: `41455729617631891617079146274334578620680336385950449493323477830932651538824`
...
[random_txn]: https://polygonscan.com/tx/0x2e7f960e74bd8599dc8e7e16f8635c7ca06dc410d5a073ba0aeabe89c4570be8

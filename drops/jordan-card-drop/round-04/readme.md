...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "0e8ZpHKGrmya4lKMuyqstEb2l4T7riTYRP60e3KPBaJ3VWvopgWVaIPuQnPaxruc",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      def5d32906f60cceb4fa69967cedb66b720d0d4c56d4a7513d5307c54c30e085
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x31db52543ccfad847fa6b308a8433b9825dd30d217577c1a21b1ec86e42bb3fc` ([polygonscan][random_txn])
  - The number we retrieved was: `42389531841522758980636634857628716203236205437841911080712053473539033528620`
...
[random_txn]: https://polygonscan.com/tx/0x31db52543ccfad847fa6b308a8433b9825dd30d217577c1a21b1ec86e42bb3fc

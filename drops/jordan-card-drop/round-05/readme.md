...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "arM8vlmwTF1BqT2O3UBqGD0pR50tvoOUK7KYw8Nu5fkQqU94bUx1auyZT8NRtGx0",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      95bb94e5e049e3915308377f9ed71b73cc6980e498efb9f3fc181843c4a088d7
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x895e01c456862f6580c984b950420552d11ad44cc34dd4c795029bf46f96e02f` ([polygonscan][random_txn])
  - The number we retrieved was: `65082391786949855133527399911035266250208889907057187218879499706154387709900`
...
[random_txn]: https://polygonscan.com/tx/0x895e01c456862f6580c984b950420552d11ad44cc34dd4c795029bf46f96e02f

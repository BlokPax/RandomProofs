...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "hSO3sVXnNneJpQ4yJuHrC0iJVA8iKHSzHO5C7pfJTNKlpqFjj7vON5XBUTxppD4g",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      8fe188f700ca6aef00d55ea696485d0128a02c065c994280f195eceb9b80ce22
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x42190ed9011b338a5da80f2a4ed50085391ca1cc9a9fb85a83d6949cf0e4136d` ([polygonscan][random_txn])
  - The number we retrieved was: `111462805901968492833369653807229743554337997686460896591265442725347674876871`
...
[random_txn]: https://polygonscan.com/tx/0x42190ed9011b338a5da80f2a4ed50085391ca1cc9a9fb85a83d6949cf0e4136d

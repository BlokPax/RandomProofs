...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "Z5zB0IQifvkIu0GD6k3lBQe0UEXt8W8NnBGHnffz6hwIiDgf8XNHmNVtytbnuMMG",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      d73b9c2b02ec8189eb3131764720454fe51d43dfb28244eebb93397585ffe4a3
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xc72b5e3156c6de5fe2278aca8e7cc24bb63df9073c09f7097f8e352e2f950bc4` ([polygonscan][random_txn])
  - The number we retrieved was: `50985074260586523513889849554281619754547050370773367773250282174708626876838`
...
[random_txn]: https://polygonscan.com/tx/0xc72b5e3156c6de5fe2278aca8e7cc24bb63df9073c09f7097f8e352e2f950bc4

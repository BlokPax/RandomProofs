...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "ZWoqFSgAH5tZ88xvSoT3S3J6RWK1kyF9bW01gMtIuCClDFbr5TSdIpv8Y2cEB74j",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      656f072e21ff8074635ab746f5946da6cb3f84066b19739886395bf643269ece
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x18d8cd140d2b66454be7bf1b7ece5d0b6ca94e66c66bb6691bbed1d022037b61` ([polygonscan][random_txn])
  - The number we retrieved was: `24283068396312161903454530144398314777500689831730975808358129187187953791772`
...
[random_txn]: https://polygonscan.com/tx/0x18d8cd140d2b66454be7bf1b7ece5d0b6ca94e66c66bb6691bbed1d022037b61

...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "PQX3Mmg15po2aWVon0nWBH9Cu163DemQrOdIA4YlxnKYFLMb63HJallVcXxe6jxp",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      f42f1ade83ecf3581844b81f0fec3f0148b82d8da7a0794fc1249b712d91d98a
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x6ba60b98b0f0b7ee3f303c677c85605bde7953440489477a4463c5b34844bcca` ([polygonscan][random_txn])
  - The number we retrieved was: `35361453762544701907296096197203603823198522694022855620832664082772345370246`
...
[random_txn]: https://polygonscan.com/tx/0x6ba60b98b0f0b7ee3f303c677c85605bde7953440489477a4463c5b34844bcca

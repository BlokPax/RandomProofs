...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "WC6Oe4tCnnpayp33WkKsI6Im7anpAGwtsCat7SbDSJy3VNEaoQplcdpto21skcYi",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      43792ea456819584db57d6d46ed4f10648dca5c18155094b01b3fa9950a8d1f7
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x81ad4f255a60cd5e482954ec8cf558ff6fe185df9f2dcc770dcec8b9bc82a276` ([polygonscan][random_txn])
  - The number we retrieved was: `30682239746125953895022738372868815029955022241517921056452702765466656302812`
...
[random_txn]: https://polygonscan.com/tx/0x81ad4f255a60cd5e482954ec8cf558ff6fe185df9f2dcc770dcec8b9bc82a276

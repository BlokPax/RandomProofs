...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "SJgmyPnHWNKfFM9NgV4Itabk65kWLsaYb3KyIIhSAhcMBueetY8mWtlOCvkohepx",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      b06dd6e1f1ece40122ceaf2c830d069f4ff130c8cb45a6f97861fb4b30b5c416
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x60e0f20c38447dc758efa8da271887fc049aa9021251e0e83e6b64898428e296` ([polygonscan][random_txn])
  - The number we retrieved was: `12192023286138556102617165545962763599124000072959386016903774651314271820981`
...
[random_txn]: https://polygonscan.com/tx/0x60e0f20c38447dc758efa8da271887fc049aa9021251e0e83e6b64898428e296

...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "CqtwEZoqDGIM7mprwyQpl5potCN4y9gP2ujqw9F6FNDuLxm1lu1ZLITwBWwUlbYJ",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      5dc1ff630c3c14a634bf9ef726132ccbc946c4e3a61edc6c0774ee5900f0eb49
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x833fb408b61ba663d451ace3f46a150cd962c2b2137898c579a2de349bdb9ca2` ([polygonscan][random_txn])
  - The number we retrieved was: `74316951571154774404665102509401784946241123187351124041742184716183225776387`
...
[random_txn]: https://polygonscan.com/tx/0x833fb408b61ba663d451ace3f46a150cd962c2b2137898c579a2de349bdb9ca2

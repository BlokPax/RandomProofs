...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "kKPeWcFnzmMHIfLyBKkCceMKhE24z0afp6FUFVHpRss5TW2DXpmSJHhQfSRW9j8o",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      fd28ee951f0fe00956cf516d9e88740fc062b114a2090c2a6b4786c1e84695de
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x26e5b8654a580785dcc88d33f6318e575180ae1527a8e5a14bebf8c5014b8c76` ([polygonscan][random_txn])
  - The number we retrieved was: `79023544136098729780106881335200697092921889625896251219577516881147964955433`
...
[random_txn]: https://polygonscan.com/tx/0x26e5b8654a580785dcc88d33f6318e575180ae1527a8e5a14bebf8c5014b8c76

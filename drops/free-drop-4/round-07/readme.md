...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "FNVdRyJAXH7V7Mb25dS74T7yg0oPHPFKV8tPEEhnL4ilXREfbrTZEeqVAyvzEAVL",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      d8a412ab4b5a649faba1c52e81f0be74d97055bc758d889aaa0680e9b142f73e
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x1cbaedf80e265988e9a6c347bc84152f970e315a38d933ffc1210c28ac88496d` ([polygonscan][random_txn])
  - The number we retrieved was: `115419670168600748594544384092175663787215715243151210126306825750124002404888`
...
[random_txn]: https://polygonscan.com/tx/0x1cbaedf80e265988e9a6c347bc84152f970e315a38d933ffc1210c28ac88496d

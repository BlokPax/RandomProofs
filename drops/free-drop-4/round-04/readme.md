...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "qqGn7yZGXVY6snhVqVV9pIL1tNYLhGGbWrETfQYCjNfrbSXTs3tQSZZsdSXbkTmD",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      afef17c304bcc1839bd363c465d9ab61c05add24effb1bd80ef41ca9777288a2
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x97f0e475282d3f79e72f988d2e46c9e5af6c79b8d0e47fa16049c4ed39e3f723` ([polygonscan][random_txn])
  - The number we retrieved was: `86981580056851165806199143687013782593844314014816026035028210886501138974703`
...
[random_txn]: https://polygonscan.com/tx/0x97f0e475282d3f79e72f988d2e46c9e5af6c79b8d0e47fa16049c4ed39e3f723

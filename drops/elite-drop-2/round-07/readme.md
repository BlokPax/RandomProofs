...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "1WDeEbTCN1SPJ9TLKOSq1BOWlSC7OFckfyNLOHJdEJysbDpg79B47tHcA6x3MiD1",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      4c1496c60ff22cb8bd07ba55f85e7d2bc11a7823edbeff9090a46b45929af487
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xc6b2f7237a0fa1796781839375723dbd6c956f552689fc6119b9a7b516f5550a` ([polygonscan][random_txn])
  - The number we retrieved was: `86517811752992557749336103609765956481939802910148010427290161928252066452783`
...
[random_txn]: https://polygonscan.com/tx/0xc6b2f7237a0fa1796781839375723dbd6c956f552689fc6119b9a7b516f5550a

...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "NxWTTFmdnlShgvXWCKlxFnmv9tltlMrYHOJKIu9hyyuMzYCLBaqhN67Ne4qwr1iL",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      ab017873870fe6c852410455072c00a9994a80fd34938a50e7048052bae45d07
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xa6e5bd24367369304b98dc32eaeee8c15ba2a9e46811f721de9709da344c29ed` ([polygonscan][random_txn])
  - The number we retrieved was: `79722050100311880134395992803486891071430803337466362886184896379374513767405`
...
[random_txn]: https://polygonscan.com/tx/0xa6e5bd24367369304b98dc32eaeee8c15ba2a9e46811f721de9709da344c29ed

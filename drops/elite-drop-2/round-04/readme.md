...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "MM8yTfUCW0dImm9eFwrv8wzRr6hf6DZzESRqBxMGLD9JITY1lRewQ4NdcntmXGxq",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      3f2ee48b769f49a95a48b4e31a5f6ff4b399c7b9268a022720c2c1641d848466
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xe7aafeb2d23d3e8c17cc57c542f25458457d408dd6e8948b5589565f9796409b` ([polygonscan][random_txn])
  - The number we retrieved was: `8670140523347300309153146586215110064024155416316402104296044073732325458356`
...
[random_txn]: https://polygonscan.com/tx/0xe7aafeb2d23d3e8c17cc57c542f25458457d408dd6e8948b5589565f9796409b

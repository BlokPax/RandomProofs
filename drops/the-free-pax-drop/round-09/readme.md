...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "uRogmzh1hG4kYOJllX571o98v8MsGaFh3RI0ohdO6gN6F0RtScNr277GRJwIu765",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      67e29ac5b7af1e9e058b31d411423b9f4df6a8a5aab3957dd4d2ff14ab548174
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xd47bbbc1891210224c12d386114b9834ba88ced01cd5b94864adfbaf08346bb0` ([polygonscan][random_txn])
  - The number we retrieved was: `85114167378691889969038181179734640918799743775246991555763026248008284476599`
...
[random_txn]: https://polygonscan.com/tx/0xd47bbbc1891210224c12d386114b9834ba88ced01cd5b94864adfbaf08346bb0

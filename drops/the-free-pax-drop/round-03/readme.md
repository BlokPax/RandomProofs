...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "O0wWXzrhD7Hgwp3lEMJ4Qity1KQI9HTA7AAxGjcBL3XIJ31h9Of6DTE2zlJH1AHX",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      5876294e7fb23cf5b90f9896d80695c79e3e3b93d029e7744bdc6c67b7a28082
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x762be62885b687b960a9d299454c80e370e63ce78cf0b11684cc3357308adfd0` ([polygonscan][random_txn])
  - The number we retrieved was: `1692425559337532667723324661636781406057455764186638277420410334276597578467`
...
[random_txn]: https://polygonscan.com/tx/0x762be62885b687b960a9d299454c80e370e63ce78cf0b11684cc3357308adfd0

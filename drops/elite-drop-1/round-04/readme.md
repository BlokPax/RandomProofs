...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "DySspFKI3IyaMf4XnHAQVsG0vvEaRpZYBIWHkzgYAFPdZtu5ARO3pTFzxvnznuHq",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      1816b8b2e26e1fe2c5d2a6e25c6c88dc58e2898d4fa6ee44d880690deccc3ec8
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x524a3a3178e8510719151e6536d48f1ff42d88c37c813fcef9b78b2085b6de17` ([polygonscan][random_txn])
  - The number we retrieved was: `12259197843929074542966978930533645633715425044665752623838396277443456157508`
...
[random_txn]: https://polygonscan.com/tx/0x524a3a3178e8510719151e6536d48f1ff42d88c37c813fcef9b78b2085b6de17

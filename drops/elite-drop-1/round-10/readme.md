...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "ZuIFtaNiAtwFzqvwFLQt6609EYeL4MlkgMBIZEwrzqmJDDSMvwlrfyY1i6ziufTM",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      482382a5e9d012deab683adb482637677007ec1496995051bd30d975954c1dfe
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xee3fb2c8371dbde3e4a7890401e19419f296450b6d30a753270e456f7fd6546b` ([polygonscan][random_txn])
  - The number we retrieved was: `54896383674300463036033671260658936410551567086921729203199039142402132250688`
...
[random_txn]: https://polygonscan.com/tx/0xee3fb2c8371dbde3e4a7890401e19419f296450b6d30a753270e456f7fd6546b

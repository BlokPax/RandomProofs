...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "cc7wb7dlp4VS6IRULHtSYYCYCkTkk3GLGsHxUzJALLDAqJNJTHelZ5kN2lHFRGOB",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      91719d4a8cefb412e66175869842ce372cfa0344a0d554db9e2d4912c685a436
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x76c094b2cd004d434f2f2554a5163694f7c6fa6c33693432afbf8116b33b3a23` ([polygonscan][random_txn])
  - The number we retrieved was: `46903372635747163925612022697306342684138408436750457673036543893282392259724`
...
[random_txn]: https://polygonscan.com/tx/0x76c094b2cd004d434f2f2554a5163694f7c6fa6c33693432afbf8116b33b3a23

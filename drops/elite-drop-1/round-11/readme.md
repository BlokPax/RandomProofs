...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "KY6FijAdUcwSgWd5BuSGbCNAOA7UmfLV4EN34qzcgwvn24kBtsLfx3XCoKyOS1Sj",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      0233eb014a84023e9e1363e343f872cbc60f50c1e85e73c63fb5d065c1fabdef
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x7e2e0fe44d58eb8cae6414edd6c1749bb0973d93e28a8b627363f8175b01b50f` ([polygonscan][random_txn])
  - The number we retrieved was: `37202079382083205872058223785127145602529627356346377424481204498594742290327`
...
[random_txn]: https://polygonscan.com/tx/0x7e2e0fe44d58eb8cae6414edd6c1749bb0973d93e28a8b627363f8175b01b50f

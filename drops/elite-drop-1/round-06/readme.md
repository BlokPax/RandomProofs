...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "24huf4ZJxaZ9s393mnBRPO8brPCZyDZuNen3obo0pd0MTnoeErLnAxdbPl2jM3nO",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      6bd7c7babd531699d5067a884831cb69ddead25aac60e1860b20c6ec0c36f0bb
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x570932afdb295417144e456e5df7239d9791bf3c2be89499e8279e7028bbf482` ([polygonscan][random_txn])
  - The number we retrieved was: `90531875430951183268914945631191093375295752485232115609606817496187094618410`
...
[random_txn]: https://polygonscan.com/tx/0x570932afdb295417144e456e5df7239d9791bf3c2be89499e8279e7028bbf482

...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "uSNIXTDwikY3vkgxvk0xkrShgwOu8gYfhGTtHtEm5f7BagRrhK8n99nYUmrihffM",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      8fdee4199346f1026f61f088509a6e89fb3948d41b6fd8dbcd7108296f243fad
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0xcc72a7d2bf9d5087bdc85bf1d3b27ee2ecdbe335415c5855ad7a9cf0e1949a49` ([polygonscan][random_txn])
  - The number we retrieved was: `80633316413973782629695679160440144499615983840307709167551865089933559332093`
...
[random_txn]: https://polygonscan.com/tx/0xcc72a7d2bf9d5087bdc85bf1d3b27ee2ecdbe335415c5855ad7a9cf0e1949a49

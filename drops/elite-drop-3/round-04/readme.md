...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "cIg9j1j8fIREZMj2CXbkDZIwXETqiiaLpRKUEymM0IAmy443xLMaFIdRrVI4TYCr",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      88dbe2c6b60e3db99ad31bf3543cf37200f19b4413016fbbadc36f4a236d4cb6
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x6e939f9f6a0963a439f1c557c09ab1059d9c3e9f2673b7c07ce5d5eb12a0d651` ([polygonscan][random_txn])
  - The number we retrieved was: `9804492120809018666884838568280563133145794042882386794685195896437516660449`
...
[random_txn]: https://polygonscan.com/tx/0x6e939f9f6a0963a439f1c557c09ab1059d9c3e9f2673b7c07ce5d5eb12a0d651

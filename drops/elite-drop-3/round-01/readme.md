...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "SzsvwHEieOieIJd86RbCZ4bKo9f7TL8CySBglKjGlMurjysTHcashvOZIxCTKnfc",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      d367a5b415d1a53399ddfa5fb65c3cc8f7f83abadbcb555560b680174762379d
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x5f82dcf3e7a35bcea0dfeb86b642e3f3646f338a668388de0f3b25aa8ff34157` ([polygonscan][random_txn])
  - The number we retrieved was: `40808414443477179885668846512600667134652662895281771165978323768184431145068`
...
[random_txn]: https://polygonscan.com/tx/0x5f82dcf3e7a35bcea0dfeb86b642e3f3646f338a668388de0f3b25aa8ff34157

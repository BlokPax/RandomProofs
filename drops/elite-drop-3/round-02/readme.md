...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "z4coo7GYp65e6CPwafJs6h1xYvzvL2rmpNmJRVvOkAxHKolfynE1LsvmknTJWb5x",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      e735473d25669f9ec96393f4db3af3816a35b4eb54e1f8967fffc9bf6435f2f3
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x1101d22e44fad99f0fb28188d6a11edf20f28cf152e0cad6bfd95f7d38c2bc92` ([polygonscan][random_txn])
  - The number we retrieved was: `29065561999347392315184151018091027278428736972330002628081653450359472462605`
...
[random_txn]: https://polygonscan.com/tx/0x1101d22e44fad99f0fb28188d6a11edf20f28cf152e0cad6bfd95f7d38c2bc92

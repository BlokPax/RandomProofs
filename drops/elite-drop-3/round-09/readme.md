...
- To build the hash, we start with this object:
  ```jsonc
  {
    ...
    "salt": "2ZoxGelRgHfoVZGknybNMDfJmhAj4l4AAmnSTcDU6cssGGE7HIsYyAStJrzCWzHp",
  ...
  - We minify the object (which is reproduced [here][ledger_full]), `sha256` the result and encode the result to hex.
    - Thus, our calculated hash is:
      ```plain
      4255b1a0af9de3c6cf70e1df23579d6777644d6d3db4496343e90a4d22839d2e
      ```

### 3. We send our hash up to the on-chain random oracle to get our random number.
  - The transaction hash to retrieve this random number was: `0x0c579ce82c8cc3813ebe9570af57294435e105a814277f557518a43ec2420e37` ([polygonscan][random_txn])
  - The number we retrieved was: `12365461284517452536118982319291291679009701362192441595792642274182332843225`
...
[random_txn]: https://polygonscan.com/tx/0x0c579ce82c8cc3813ebe9570af57294435e105a814277f557518a43ec2420e37
